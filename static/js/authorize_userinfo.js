; (function (w) {
  w.matk = "vebvredb";//$.fn.cookie(mpappid + '_matk');
  w.openid = "vebvredb";//$.fn.cookie(mpappid + '_openid');
  w.headimgurl = "vebvredb";//$.fn.cookie(mpappid + '_headimgurl');
  w.nickname = "vebvredb";//$.fn.cookie(mpappid + '_nickname');
